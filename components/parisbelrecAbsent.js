...
class ParisBelrecAbsent extends React.Component {
  constructor() {
    super();
    this.state = {
      color: 'white',
  ...
  changeColor = () => {
    ...
    var parisbelrecAbsent_ref = db.ref('Students/'+4+'/')
    parisbelrecAbsent_ref.update({
      attendance: "absent"
    })
...
export default ParisBelrecAbsent;
