...
class ParisBelrecPresent extends React.Component {
  constructor() {
    super();
    this.state = {
      color: 'white',
  ...
  changeColor = () => {
    ...
    var parisbelricPresent_ref = db.ref('Students/'+4+'/')
    parisbelricPresent_ref.update({
      attendance: "present"
    })
...
export default ParisBelrecPresent;
